...
var ki = (e, t, r) => t in e ? Ai(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var Ct = (e, t, r) => ki(e, typeof t != "symbol" ? t + "" : t, r), Ys = (e, t, r) => t.has(e) || xs("Cannot " + r);
var Q = (e, t, r) => (Ys(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Dt = (e, t, r) => t.has(e) ? xs("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Lt = (e, t, r, n) => (Ys(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r);
import Ln, { ipcMain as Et, shell as Ci, app as Oe, globalShortcut as Kt, BrowserWindow as fo } from "electron";
import ho from "node:assert";
import G from "node:fs";
import Yt from "node:os";
import X from "node:path";
import Di, { promisify as le, isDeepStrictEqual as Li } from "node:util";
import { createRequire as Mi } from "node:module";
import { fileURLToPath as Vi } from "node:url";
import se from "node:process";
import Mt from "node:crypto";
import { WebSocketServer as Ui } from "ws";
var Zs = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function mo(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var Zt = {}, wt = 1e3, bt = wt * 60, St = bt * 60, ot = St * 24, zi = ot * 7, Fi = ot * 365.25, qi = function(e, t) {
  t = t || {};
  var r = typeof e;
  if (r === "string" && e.length > 0)
    return Gi(e);
  if (r === "number" && isFinite(e))
    return t.long ? Hi(e) : Ki(e);
  throw new Error(
...
var Xi = xi, Wi = /^(?:\w+:)?\/\/(\S+)$/, Bi = /^localhost[\:?\d]*(?:[^\:?\d]\S*)?$/, Ji = /^[^\s\.]+\.\S{2,}$/;
function xi(e) {
  if (typeof e != "string")
    return !1;
  var t = e.match(Wi);
  if (!t)
    return !1;
  var r = t[1];
  return r ? !!(Bi.test(r) || Ji.test(r)) : !1;
}
var Yi = Xi, Zi = /(?:(?:[^:]+:)?[/][/])?(?:.+@)?([^/]+)([/][^?#]+)/, Qi = function(e, t) {
  var r = {};
  ...
  if (n)
    ...
    if (e = e.replace(/^git\+/, ""), !Yi(e))
      return null;
    var o = e.match(Zi) || [], l = o[1], i = o[2];
...
const ec = "update-electron-app", tc = "3.1.1", rc = {
  name: ec,
  version: tc
};
var Rt = Zs && Zs.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Zt, "__esModule", { value: !0 });
Zt.UpdateSourceType = void 0;
var nc = Zt.updateElectronApp = uc;
Zt.makeUserNotifier = $o;
const po = Rt(qi), sc = Rt(Qi), Je = Rt(ho), ac = Rt(G), Qs = Rt(Yt), oc = Rt(X), ic = Di, he = Ln;
var at;
(function(e) {
  e[e.ElectronPublicUpdateService = 0] = "ElectronPublicUpdateService", e[e.StaticStorage = 1] = "StaticStorage";
})(at || (Zt.UpdateSourceType = at = {}));
const ea = rc, cc = (0, ic.format)("%s/%s (%s: %s)", ea.name, ea.version, Qs.default.platform(), Qs.default.arch()), lc = ["darwin", "win32"], ta = (e) => {
  try {
...
function uc(e = {}) {
  ...
  he.app.isReady() ? ra(t) : he.app.on("ready", () => ra(t));
}
function ra(e) {
  const { updateSource: t, updateInterval: r, logger: n } = e;
  if (!lc.includes(process == null ? void 0 : process.platform)) {
  ...
  l("feedURL", s), l("requestHeaders", o), he.autoUpdater.setFeedURL({
    ...
    l("update-downloaded", [i, u, c, f, _]), typeof e.onNotifyUser != "function" ? ((0, Je.default)(e.onNotifyUser === void 0, "onNotifyUser option must be a callback function or undefined"), l("update-downloaded: notifyUser is true, opening default dialog"), e.onNotifyUser = $o()) : l("update-downloaded: notifyUser is true, running custom onNotifyUser callback"), e.onNotifyUser({
      event: i,
      releaseNotes: u,
      releaseDate: f,
      releaseName: c,
...
function dc() {
  var e;
  const t = ac.default.readFileSync(oc.default.join(he.app.getAppPath(), "package.json")), r = JSON.parse(t.toString()), n = ((e = r.repository) === null || e === void 0 ? void 0 : e.url) || r.repository, s = (0, sc.default)(n);
...
function fc(e) {
  ...
  switch (i || (i = {
    ...
    case at.ElectronPublicUpdateService: {
      (0, Je.default)((t = i.repo) === null || t === void 0 ? void 0 : t.includes("/"), "repo is required and should be in the format `owner/repo`"), i.host || (i.host = n), (0, Je.default)(i.host && ta(i.host), "host must be a valid HTTPS URL");
      break;
    }
    case at.StaticStorage: {
      (0, Je.default)(i.baseUrl && ta(i.baseUrl), "baseUrl must be a valid HTTPS URL");
      break;
    }
  }
  return (0, Je.default)(typeof s == "string" && s.match(/^\d+/), "updateInterval must be a human-friendly string interval like `20 minutes`"), (0, Je.default)((0, po.default)(s) >= 5 * 60 * 1e3, "updateInterval must be `5 minutes` or more"), (0, Je.default)(a && typeof a.log, "function"), { updateSource: i, updateInterval: s, logger: a, notifyUser: o, onNotifyUser: l };
}
const hc = () => {
  Et.handle("open-external", (e, t) => Ci.openExternal(t));
}, it = (e) => {
  const t = typeof e;
...
const xe = Yt.homedir(), Vn = Yt.tmpdir(), { env: gt } = se, gc = (e) => {
...
function Ec(e, { suffix: t = "nodejs" } = {}) {
  if (typeof e != "string")
    throw new TypeError(`Expected a string, got ${typeof e}`);
  return t && (e += `-${t}`), se.platform === "darwin" ? gc(e) : se.platform === "win32" ? vc(e) : _c(e);
}
...
}, wc = se.getuid ? !se.getuid() : !1, bc = 1e4, ve = () => {
}, ee = {
  /* API */
  isChangeErrorOk: (e) => {
    if (!ee.isNodeError(e))
      return !1;
    const { code: t } = e;
    return t === "ENOSYS" || !wc && (t === "EINVAL" || t === "EPERM");
  },
...
class Sc {
  constructor() {
    this.interval = 25, this.intervalId = void 0, this.limit = bc, this.queueActive = /* @__PURE__ */ new Set(), this.queueWaiting = /* @__PURE__ */ new Set(), this.init = () => {
...
const Pc = new Sc(), Ke = (e, t) => function(n) {
  return function s(...a) {
    return Pc.schedule().then((o) => {
      const l = (u) => (o(), u), i = (u) => {
        if (o(), Date.now() >= n)
          throw u;
        if (t(u)) {
...
}, Rc = "utf8", sa = 438, Ic = 511, Nc = {}, Oc = Yt.userInfo().uid, Tc = Yt.userInfo().gid, jc = 1e3, Ac = !!se.getuid;
se.getuid && se.getuid();
const aa = 128, kc = (e) => e instanceof Error && "code" in e, oa = (e) => typeof e == "string", cn = (e) => e === void 0, Cc = se.platform === "linux", go = se.platform === "win32", Un = ["SIGABRT", "SIGALRM", "SIGHUP", "SIGINT", "SIGTERM"];
go || Un.push("SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
Cc && Un.push("SIGIO", "SIGPOLL", "SIGPWR", "SIGSTKFLT", "SIGUNUSED");
class Dc {
  /* CONSTRUCTOR */
  constructor() {
...
const Lc = new Dc(), Mc = Lc.register, fe = {
  /* VARIABLES */
  store: {},
  /* API */
  create: (e) => {
...
function vo(e, t, r = Nc) {
  ...
  try {
    ...
    o = de.retry.openSync(n)(a, "w", r.mode || sa), r.tmpCreated && r.tmpCreated(a), oa(t) ? de.retry.writeSync(n)(o, t, 0, r.encoding || Rc) : cn(t) || de.retry.writeSync(n)(o, t, 0, t.length, 0), r.fsync !== !1 && (r.fsyncWait !== !1 ? de.retry.fsyncSync(n)(o) : de.attempt.fsync(o)), de.retry.closeSync(n)(o), o = null, r.chown && (r.chown.uid !== Oc || r.chown.gid !== Tc) && de.attempt.chownSync(a, r.chown.uid, r.chown.gid), r.mode && r.mode !== sa && de.attempt.chmodSync(a, r.mode);
    try {
...
var wn = { exports: {} }, zn = {}, Se = {}, Pt = {}, Qt = {}, F = {}, xt = {};
(function(e) {
...
T.schemaHasRulesButRef = Fc;
function qc({ topSchemaRef: e, schemaPath: t }, r, n, s) {
  if (!s) {
...
T.eachItem = Hc;
function ia({ mergeNames: e, mergeToName: t, mergeValues: r, resultToName: n }) {
  return (s, a, o, l) => {
...
function Xc(e, t) {
  return e.scopeValue("func", {
    ref: t,
    code: ca[t.code] || (ca[t.code] = new Vc._Code(t.code))
  });
}
T.useFunc = Xc;
var Sn;
...
const Jc = Qt, xc = F, Yc = Ee, Zc = {
  message: "boolean schema is false"
};
function Qc(e) {
  const { gen: t, schema: r, validateName: n } = e;
  r === !1 ? Po(e, !1) : typeof r == "object" && r.$async === !0 ? t.return(Yc.default.data) : (t.assign((0, xc._)`${n}.errors`, null), t.return(!0));
}
Pt.topBoolOrEmptySchema = Qc;
function el(e, t) {
  const { gen: r, schema: n } = e;
  n === !1 ? (r.var(t, !1), Po(e)) : r.var(t, !0);
}
Pt.boolOrEmptySchema = el;
function Po(e, t) {
  ...
  (0, Jc.reportError)(s, Zc, void 0, t);
}
var ne = {}, ct = {};
Object.defineProperty(ct, "__esModule", { value: !0 });
ct.getRules = ct.isJSONType = void 0;
const tl = ["string", "number", "integer", "boolean", "null", "object", "array"], rl = new Set(tl);
function nl(e) {
  return typeof e == "string" && rl.has(e);
}
ct.isJSONType = nl;
function sl() {
  const e = {
...
function al({ schema: e, self: t }, r) {
  const n = t.RULES.types[r];
  return n && n !== !0 && Ro(e, n);
}
Ue.schemaHasRulesForType = al;
function Ro(e, t) {
...
const ol = ct, il = Ue, cl = Qt, K = F, No = T;
var vt;
(function(e) {
...
ne.getSchemaTypes = ll;
function Oo(e) {
  const t = Array.isArray(e) ? e : e ? [e] : [];
  if (t.every(ol.isJSONType))
    return t;
  throw new Error("type must be JSONType or JSONType[]: " + t.join(","));
}
ne.getJSONTypes = Oo;
function ul(e, t) {
  const { gen: r, data: n, opts: s } = e, a = dl(t, s.coerceTypes), o = t.length > 0 && !(a.length === 0 && t.length === 1 && (0, il.schemaHasRulesForType)(e, t[0]));
  if (o) {
    const l = Gn(t, n, s.strictNumbers, vt.Wrong);
    r.if(l, () => {
      a.length ? fl(e, t, a) : Kn(e);
    });
  }
  return o;
}
ne.coerceAndCheckDataType = ul;
...
function hl({ gen: e, parentData: t, parentDataProperty: r }, n) {
  e.if((0, K._)`${t} !== undefined`, () => e.assign((0, K._)`${t}[${r}]`, n));
}
function Pn(e, t, r, n = vt.Correct) {
...
function yl(e, t) {
  ...
  if (t === "object" && r)
    for (const s in r)
      la(e, s, r[s].default);
  else t === "array" && Array.isArray(n) && n.forEach((s, a) => la(e, a, s.default));
}
Or.assignDefaults = yl;
function la(e, t, r) {
  ...
  if (s) {
    (0, $l.checkStrictMode)(e, `default is ignored for: ${l}`);
    return;
  }
...
H.checkReportMissingProp = vl;
function _l({ gen: e, data: t, it: { opts: r } }, n, s) {
  return (0, Z.or)(...n.map((a) => (0, Z.and)(Wn(e, t, a, r.ownProperties), (0, Z._)`${s} = ${a}`)));
}
H.checkMissingProp = _l;
function El(e, t) {
  e.setParams({ missingProperty: t }, !0), e.error();
}
H.reportMissingProp = El;
function jo(e) {
  return e.scopeValue("func", {
...
H.schemaProperties = bl;
function Sl({ schemaCode: e, data: t, it: { gen: r, topSchemaRef: n, schemaPath: s, errorPath: a }, it: o }, l, i, u) {
...
H.callValidateCode = Sl;
const Pl = (0, Z._)`new RegExp`;
function Rl({ gen: e, it: { opts: t } }, r) {
  const n = t.unicodeRegExp ? "u" : "", { regExp: s } = t.code, a = s(r, n);
  return e.scopeValue("pattern", {
    key: a.toString(),
    ref: a,
    code: (0, Z._)`${s.code === "new RegExp" ? Pl : (0, gl.useFunc)(e, s)}(${r}, ${n})`
  });
}
H.usePattern = Rl;
function Il(e) {
...
function Al(e, t) {
  ...
  function _() {
    if (t.errors === !1)
      y(), t.modifying && ua(e), v(() => e.error());
    else {
      const m = t.async ? $() : E();
      t.modifying && ua(e), v(() => kl(e, m));
    }
  }
  function $() {
  ...
  function y(m = t.async ? (0, me._)`await ` : me.nil) {
    ...
    n.assign(f, (0, me._)`${m}${(0, Ol.callValidateCode)(e, c, w, R)}`, t.modifying);
  }
  function v(m) {
    var w;
...
function kl(e, t) {
  ...
  r.if((0, me._)`Array.isArray(${t})`, () => {
    r.assign(tt.default.vErrors, (0, me._)`${tt.default.vErrors} === null ? ${t} : ${tt.default.vErrors}.concat(${t})`).assign(tt.default.errors, (0, me._)`${tt.default.vErrors}.length`), (0, Tl.extendErrors)(e);
  }, () => e.error());
}
function Cl({ schemaEnv: e }, t) {
  if (t.async && !e.$async)
...
Ce.validSchemaType = Dl;
function Ll({ schema: e, opts: t, self: r, errSchemaPath: n }, s, a) {
...
Ce.validateKeywordUsage = Ll;
var Qe = {};
Object.defineProperty(Qe, "__esModule", { value: !0 });
Qe.extendSubschemaMode = Qe.extendSubschemaData = Qe.getSubschema = void 0;
const ke = F, Co = T;
function Ml(e, { keyword: t, schemaProp: r, schema: n, schemaPath: s, errSchemaPath: a, topSchemaRef: o }) {
...
Qe.getSubschema = Ml;
function Vl(e, t, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
...
Qe.extendSubschemaData = Vl;
function Ul(e, { jtdDiscriminator: t, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: a }) {
  n !== void 0 && (e.compositeRule = n), s !== void 0 && (e.createErrors = s), a !== void 0 && (e.allErrors = a), e.jtdDiscriminator = t, e.jtdMetadata = r;
}
Qe.extendSubschemaMode = Ul;
...
const ql = T, Gl = Do, Kl = Fl, Hl = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function Mo(e) {
  ...
  for (const r in e) {
    if (r === "$ref")
      return 1 / 0;
    if (t++, !Hl.has(r) && (typeof e[r] == "object" && (0, ql.eachItem)(e[r], (n) => t += Mo(n)), t === 1 / 0))
      return 1 / 0;
  }
  return t;
}
...
const zo = Pt, da = ne, Bn = Ue, br = ne, Zl = Or, Ht = Ce, ln = Qe, D = F, z = Ee, Ql = ce, ze = T, Vt = Qt;
function eu(e) {
  if (Go(e) && (Ko(e), qo(e))) {
    nu(e);
    return;
...
function Fo({ gen: e, validateName: t, schema: r, schemaEnv: n, opts: s }, a) {
  s.code.es5 ? e.func(t, (0, D._)`${z.default.data}, ${z.default.valCxt}`, n.$async, () => {
    e.code((0, D._)`"use strict"; ${fa(r, s)}`), ru(e, s), e.code(a);
  }) : e.func(t, (0, D._)`${z.default.data}, ${tu(s)}`, n.$async, () => e.code(fa(r, s)).code(a));
}
function tu(e) {
...
function nu(e) {
  ...
  Fo(e, () => {
    r.$comment && t.$comment && Xo(e), cu(e), n.let(z.default.vErrors, null), n.let(z.default.errors, 0), r.unevaluated && su(e), Ho(e), du(e);
  });
}
function su(e) {
...
function ou(e, t) {
  ...
  s.$comment && r.$comment && Xo(e), lu(e), uu(e);
  const a = n.const("_errs", z.default.errors);
  Ho(e, a), n.var(t, (0, D._)`${a} === ${z.default.errors}`);
}
function Ko(e) {
  (0, ze.checkUnknownRules)(e), iu(e);
}
function Ho(e, t) {
  if (e.opts.jtd)
    return ha(e, [], !1, t);
  const r = (0, da.getSchemaTypes)(e.schema), n = (0, da.coerceAndCheckDataType)(e, r);
  ha(e, r, !n, t);
}
function iu(e) {
...
function lu(e) {
  ...
  t && (e.baseId = (0, Ql.resolveUrl)(e.opts.uriResolver, e.baseId, t));
}
function uu(e) {
...
function du(e) {
  ...
  r.$async ? t.if((0, D._)`${z.default.errors} === 0`, () => t.return(z.default.data), () => t.throw((0, D._)`new ${s}(${z.default.vErrors})`)) : (t.assign((0, D._)`${n}.errors`, z.default.vErrors), a.unevaluated && fu(e), t.return((0, D._)`${z.default.errors} === 0`));
}
function fu({ gen: e, evaluated: t, props: r, items: n }) {
...
function ha(e, t, r, n) {
  ...
  i.jtd || hu(e, t), s.block(() => {
    for (const _ of c.rules)
      f(_);
    f(c.post);
  });
  function f(_) {
    (0, Bn.shouldUseGroup)(a, _) && (_.type ? (s.if((0, br.checkDataType)(_.type, o, i.strictNumbers)), ma(e, _), t.length === 1 && t[0] === _.type && r && (s.else(), (0, br.reportTypeError)(e)), s.endIf()) : ma(e, _), l || s.if((0, D._)`${z.default.errors} === ${n || 0}`));
  }
}
function ma(e, t) {
  const { gen: r, schema: n, opts: { useDefaults: s } } = e;
  s && (0, Zl.assignDefaults)(e, t.type), r.block(() => {
    for (const a of t.rules)
      (0, Bn.shouldUseRule)(n, a) && Jo(e, a.keyword, a.definition, t.type);
  });
}
function hu(e, t) {
  e.schemaEnv.meta || !e.opts.strictTypes || (mu(e, t), e.opts.allowUnionTypes || pu(e, t), $u(e, e.dataTypes));
}
function mu(e, t) {
  if (t.length) {
...
function $u(e, t) {
  ...
  for (const n in r) {
    ...
    if (typeof s == "object" && (0, Bn.shouldUseRule)(e.schema, s)) {
      ...
      a.length && !a.some((o) => yu(t, o)) && Jn(e, `missing type "${a.join(",")}" for keyword "${n}"`);
    }
  }
}
function yu(e, t) {
...
const Re = F, bu = It, et = Ee, Ne = ce, pa = T, Su = Se;
class Tr {
  constructor(t) {
    var r;
...
function xn(e) {
  ...
  let c;
  try {
    this._compilations.add(e), (0, Su.validateFunctionCode)(u), o.optimize(this.opts.code.optimize);
    const f = o.toString();
...
function dn(e, { baseId: t, schema: r, root: n }) {
  ...
  for (const l of e.fragment.slice(1).split("/")) {
    if (typeof r == "boolean")
      return;
    const i = r[(0, pa.unescapeFragment)(l)];
    if (i === void 0)
      return;
    r = i;
    const u = typeof r == "object" && r[this.opts.schemaId];
    !Ou.has(l) && u && (t = (0, Ne.resolveUrl)(this.opts.uriResolver, t, u));
  }
  let a;
  if (typeof r != "boolean" && r.$ref && !(0, pa.schemaHasRulesButRef)(r, this.RULES)) {
...
const Tu = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", ju = "Meta-schema for $data reference (JSON AnySchema extension proposal)", Au = "object", ku = [
  "$data"
], Cu = {
  $data: {
    type: "string",
...
const { HEX: Uu } = Vu, zu = /^(?:(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)$/u;
function Zo(e) {
  if (ei(e, ".") < 3)
    return { host: e, isIPV4: !1 };
  const t = e.match(zu) || [], [r] = t;
  return r ? { host: qu(r, "."), isIPV4: !0 } : { host: e, isIPV4: !1 };
}
function $a(e, t = !1) {
  let r = "", n = !0;
  for (const s of e) {
    if (Uu[s] === void 0) return;
    s !== "0" && n === !0 && (n = !1), n || (r += s);
  }
...
function Fu(e) {
  ...
  return s.length && (a ? r.zone = s.join("") : l ? n.push(s.join("")) : n.push($a(s))), r.address = n.join(""), r;
}
function Qo(e) {
  if (ei(e, ":") < 2)
...
var Wu = {
  ...
  normalizeComponentEncoding: Hu,
  removeDotSegments: Ku,
  normalizeIPv4: Zo,
  normalizeIPv6: Qo
};
const Bu = /^[\da-f]{8}-[\da-f]{4}-[\da-f]{4}-[\da-f]{4}-[\da-f]{12}$/iu, Ju = /([\da-z][\d\-a-z]{0,31}):((?:[\w!$'()*+,\-.:;=@]|%[\da-f]{2})+)/iu;
function ti(e) {
...
function ed(e, t) {
  const r = e;
  return r.uuid = r.nss, r.nss = void 0, !t.tolerant && (!r.uuid || !Bu.test(r.uuid)) && (r.error = r.error || "UUID is not valid."), r;
}
function td(e) {
  const t = e;
...
var od = Zn;
const { normalizeIPv6: id, normalizeIPv4: cd, removeDotSegments: Ft, recomposeAuthority: ld, normalizeComponentEncoding: nr } = Wu, Qn = od;
function ud(e, t) {
...
function De(e, t) {
  ...
  if (o !== void 0 && (n.reference !== "suffix" && s.push("//"), s.push(o), r.path && r.path.charAt(0) !== "/" && s.push("/")), r.path !== void 0) {
    let l = r.path;
    !n.absolutePath && (!a || !a.absolutePath) && (l = Ft(l)), o === void 0 && (l = l.replace(/^\/\//u, "/%2F")), s.push(l);
  }
  return r.query !== void 0 && s.push("?", r.query), r.fragment !== void 0 && s.push("#", r.fragment), s.join("");
}
const hd = Array.from({ length: 127 }, (e, t) => /[^!"$&'()*+,\-.;=_`a-z{}~]/u.test(String.fromCharCode(t)));
function md(e) {
  let t = 0;
  for (let r = 0, n = e.length; r < n; ++r)
    if (t = e.charCodeAt(r), t > 126 || hd[t])
      return !0;
  return !1;
}
const pd = /^(?:([^#/:?]+):)?(?:\/\/((?:([^#/?@]*)@)?(\[[^#/?\]]+\]|[^#/:?]*)(?::(\d*))?))?([^#?]*)(?:\?([^#]*))?(?:#((?:.|[\n\r])*))?/u;
function Fe(e, t) {
  ...
  if (o) {
    ...
    if (!r.unicodeSupport && (!l || !l.unicodeSupport) && n.host && (r.domainHost || l && l.domainHost) && a === !1 && md(n.host))
      try {
...
(function(e) {
  ...
  const n = It, s = ut, a = ct, o = pe, l = F, i = ce, u = ne, c = T, f = Lu, _ = Yn, $ = (P, p) => new RegExp(P, p);
  $.code = "new RegExp";
  ...
  function R(P) {
    ...
    const kt = P.strict, an = (p = P.code) === null || p === void 0 ? void 0 : p.optimize, Bs = an === !0 || an === void 0 ? 1 : an || 0, Js = (g = (b = P.code) === null || b === void 0 ? void 0 : b.regExp) !== null && g !== void 0 ? g : $, ji = (d = P.uriResolver) !== null && d !== void 0 ? d : _.default;
    return {
      strictSchema: (S = (h = P.strictSchema) !== null && h !== void 0 ? h : kt) !== null && S !== void 0 ? S : !0,
      strictNumbers: (M = (L = P.strictNumbers) !== null && L !== void 0 ? L : kt) !== null && M !== void 0 ? M : !0,
      strictTypes: (W = (J = P.strictTypes) !== null && J !== void 0 ? J : kt) !== null && W !== void 0 ? W : "log",
      strictTuples: (dt = (ae = P.strictTuples) !== null && ae !== void 0 ? ae : kt) !== null && dt !== void 0 ? dt : "log",
      strictRequired: (Wr = (Xr = P.strictRequired) !== null && Xr !== void 0 ? Xr : kt) !== null && Wr !== void 0 ? Wr : !1,
      code: P.code ? { ...P.code, optimize: Bs, regExp: Js } : { optimize: Bs, regExp: Js },
...
const gd = ut, _a = H, ge = F, ht = Ee, Ea = pe, sr = T, vd = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
    ...
    if ((r === "#" || r === "#/") && s === u.baseId)
      return f();
    const c = Ea.resolveRef.call(i, u, s, r);
    if (c === void 0)
      throw new gd.default(n.opts.uriResolver, s, r);
    if (c instanceof Ea.SchemaEnv)
      return _(c);
    return $(c);
    function f() {
      if (a === u)
...
function gr(e, t, r, n) {
  ...
  function c() {
    ...
    const E = s.let("valid");
    s.try(() => {
      s.code((0, ge._)`await ${(0, _a.callValidateCode)(e, t, u)}`), $(t), o || s.assign(E, !0);
    }, (y) => {
      s.if((0, ge._)`!(${y} instanceof ${a.ValidationError})`, () => s.throw(y)), _(y), o || s.assign(E, !1);
    }), e.ok(E);
  }
  function f() {
    e.result((0, _a.callValidateCode)(e, t, u), () => $(t), () => _(t));
  }
  function _(E) {
...
const rt = F, Id = T, Nd = os, Od = {
  ...
  error: Od,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, a = t === "maxLength" ? rt.operators.GT : rt.operators.LT, o = s.opts.unicode === !1 ? (0, rt._)`${r}.length` : (0, rt._)`${(0, Id.useFunc)(e.gen, Nd.default)}(${r})`;
...
const jd = H, Rr = F, Ad = {
  ...
  error: Ad,
  code(e) {
    const { data: t, $data: r, schema: n, schemaCode: s, it: a } = e, o = a.opts.unicodeRegExp ? "u" : "", l = r ? (0, Rr._)`(new RegExp(${s}, ${o}))` : (0, jd.usePattern)(e, n);
  ...
  code(e) {
    ...
    if (o.allErrors ? u() : c(), l.strictRequired) {
      ...
      for (const y of r)
        if (($ == null ? void 0 : $[y]) === void 0 && !E.has(y)) {
          ...
          (0, Ld.checkStrictMode)(o, m, o.opts.strictRequired);
        }
    }
    function u() {
      if (i || a)
    ...
    function c() {
      ...
      if (i || a) {
        ...
        t.if((0, Ut.checkMissingProp)(e, r, $)), (0, Ut.reportMissingProp)(e, $), t.else();
    }
    function f() {
      t.forOf("prop", n, ($) => {
        e.setParams({ missingProperty: $ }), t.if((0, Ut.noPropertyInData)(t, s, $, l.ownProperties), () => e.error());
      });
    }
    function _($, E) {
      e.setParams({ missingProperty: $ }), t.forOf($, n, () => {
        t.assign(E, (0, Ut.propertyInData)(t, s, $, l.ownProperties)), t.if((0, Bt.not)(E), () => {
          e.error(), t.break();
        });
      }, Bt.nil);
    }
...
const fn = ne, oe = F, Fd = T, qd = er, Gd = {
  ...
  code(e) {
    ...
    function $(E, y) {
      const v = (0, Fd.useFunc)(t, qd.default), m = t.name("outer");
...
const In = F, Hd = T, Xd = er, Wd = {
  ...
  code(e) {
    ...
    n || a && typeof a == "object" ? e.fail$data((0, In._)`!${(0, Hd.useFunc)(t, Xd.default)}(${r}, ${s})`) : e.fail((0, In._)`${a} !== ${r}`);
  }
};
fs.default = Bd;
var hs = {};
Object.defineProperty(hs, "__esModule", { value: !0 });
const qt = F, Jd = T, xd = er, Yd = {
  message: "must be equal to one of the allowed values",
  params: ({ schemaCode: e }) => (0, qt._)`{allowedValues: ${e}}`
}, Zd = {
  keyword: "enum",
  schemaType: "array",
  $data: !0,
  ...
  code(e) {
    ...
    let i;
    const u = () => i ?? (i = (0, Jd.useFunc)(t, xd.default));
    let c;
    if (l || n)
      ...
      c = (0, qt.or)(...s.map((E, y) => _($, y)));
    }
    e.pass(c);
    function f() {
      t.assign(c, !1), t.forOf("v", a, ($) => t.if((0, qt._)`${u()}(${r}, ${$})`, () => t.assign(c, !0).break()));
    }
    function _($, E) {
      const y = s[E];
      return typeof y == "object" && y !== null ? (0, qt._)`${u()}(${r}, ${$}[${E}])` : (0, qt._)`${r} === ${y}`;
    }
  }
};
hs.default = Zd;
Object.defineProperty(Cr, "__esModule", { value: !0 });
const Qd = ns, ef = ss, tf = as, rf = is, nf = cs, sf = ls, af = us, of = ds, cf = fs, lf = hs, uf = [
  // number
  Qd.default,
  ef.default,
  // string
...
Nt.validateAdditionalItems = ui;
Nt.default = ff;
var ms = {}, Ot = {};
Object.defineProperty(Ot, "__esModule", { value: !0 });
Ot.validateTuple = void 0;
const wa = F, vr = T, hf = H, mf = {
  keyword: "items",
  type: "array",
  ...
  code(e) {
    ...
    r.items = !0, !(0, vr.alwaysValidSchema)(r, t) && e.ok((0, hf.validateArray)(e));
  }
};
function di(e, t, r = e.schema) {
  ...
  const i = n.name("valid"), u = n.const("len", (0, wa._)`${a}.length`);
  r.forEach((f, _) => {
    (0, vr.alwaysValidSchema)(l, f) || (n.if((0, wa._)`${u} > ${_}`, () => e.subschema({
      keyword: o,
      schemaProp: _,
      dataProp: _
    }, i)), e.ok(i));
...
const pf = Ot, $f = {
  ...
  schemaType: ["array"],
  before: "uniqueItems",
  code: (e) => (0, pf.validateTuple)(e, "items")
};
ms.default = $f;
var ps = {};
Object.defineProperty(ps, "__esModule", { value: !0 });
const ba = F, yf = T, gf = H, vf = Nt, _f = {
  message: ({ params: { len: e } }) => (0, ba.str)`must NOT have more than ${e} items`,
  params: ({ params: { len: e } }) => (0, ba._)`{limit: ${e}}`
}, Ef = {
  keyword: "items",
  type: "array",
  ...
  code(e) {
    ...
    n.items = !0, !(0, yf.alwaysValidSchema)(n, t) && (s ? (0, vf.validateAdditionalItems)(e, s) : e.ok((0, gf.validateArray)(e)));
  }
};
ps.default = Ef;
var $s = {};
...
const or = H, Ie = F, If = Ee, ir = T, Nf = {
  ...
  code(e) {
    ...
    f(), e.ok((0, Ie._)`${a} === ${If.default.errors}`);
    function f() {
      t.forIn("key", s, (v) => {
...
const Tf = Se, Sa = H, hn = T, Pa = Mr, jf = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, parentSchema: n, data: s, it: a } = e;
    a.opts.removeAdditional === "all" && n.additionalProperties === void 0 && Pa.default.code(new Tf.KeywordCxt(a, Pa.default, "additionalProperties"));
    const o = (0, Sa.allSchemaProperties)(r);
    for (const f of o)
    ...
    for (const f of l)
      u(f) ? c(f) : (t.if((0, Sa.propertyInData)(t, s, f, a.opts.ownProperties)), c(f), a.allErrors || t.else().var(i, !0), t.endIf()), e.it.definedProperties.add(f), e.ok(i);
    function u(f) {
...
const Ra = H, cr = F, Ia = T, Na = T, Af = {
  keyword: "patternProperties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, data: n, parentSchema: s, it: a } = e, { opts: o } = a, l = (0, Ra.allSchemaProperties)(r), i = l.filter((y) => (0, Ia.alwaysValidSchema)(a, r[y]));
    ...
    a.props !== !0 && !(a.props instanceof cr.Name) && (a.props = (0, Na.evaluatedPropsToName)(t, a.props));
    const { props: f } = a;
    _();
    function _() {
      for (const y of l)
    ...
    function $(y) {
      for (const v in u)
        new RegExp(y).test(v) && (0, Ia.checkStrictMode)(a, `property ${v} matches pattern ${y} (use allowMatchingProperties)`);
    }
    function E(y) {
      t.forIn("key", n, (v) => {
        t.if((0, cr._)`${(0, Ra.usePattern)(e, y)}.test(${v})`, () => {
          const m = i.includes(y);
          m || e.subschema({
            keyword: "patternProperties",
            schemaProp: y,
            dataProp: v,
            dataPropType: Na.Type.Str
...
const _r = F, Mf = T, Vf = {
  ...
  code(e) {
    ...
    function u() {
      a.forEach((c, f) => {
        let _;
        (0, Mf.alwaysValidSchema)(s, c) ? t.var(i, !0) : _ = e.subschema({
          keyword: "oneOf",
          schemaProp: f,
          compositeRule: !0
...
const Kf = T, Hf = {
  ...
  code({ keyword: e, parentSchema: t, it: r }) {
    t.if === void 0 && (0, Kf.checkStrictMode)(r, `"${e}" without "if" is ignored`);
  }
};
Ps.default = Hf;
Object.defineProperty(Dr, "__esModule", { value: !0 });
const Xf = Nt, Wf = ms, Bf = Ot, Jf = ps, xf = $s, Yf = Lr, Zf = ys, Qf = Mr, eh = gs, th = vs, rh = _s, nh = Es, sh = ws, ah = bs, oh = Ss, ih = Ps;
function ch(e = !1) {
  const t = [
    // any
    rh.default,
  ...
  return e ? t.push(Wf.default, Jf.default) : t.push(Xf.default, Bf.default), t.push(xf.default), t;
}
Dr.default = ch;
var Rs = {}, Tt = {};
Object.defineProperty(Tt, "__esModule", { value: !0 });
Tt.dynamicAnchor = void 0;
const mn = F, lh = Ee, Ta = pe, uh = qe, dh = {
...
function mi(e, t) {
  ...
  const s = (0, mn._)`${lh.default.dynamicAnchors}${(0, mn.getProperty)(t)}`, a = n.errSchemaPath === "#" ? n.validateName : fh(e);
  r.if((0, mn._)`!${s}`, () => r.assign(s, a));
}
Tt.dynamicAnchor = mi;
function fh(e) {
  const { schemaEnv: t, schema: r, self: n } = e.it, { root: s, baseId: a, localRefs: o, meta: l } = t.root, { schemaId: i } = n.opts, u = new Ta.SchemaEnv({ schema: r, schemaId: i, root: s, baseId: a, localRefs: o, meta: l });
  return Ta.compileSchema.call(n, u), (0, uh.getValidate)(e, u);
}
Tt.default = dh;
var jt = {};
Object.defineProperty(jt, "__esModule", { value: !0 });
jt.dynamicRef = void 0;
const ja = F, hh = Ee, Aa = qe, mh = {
  keyword: "$dynamicRef",
  schemaType: "string",
...
function pi(e, t) {
  ...
  function o(i) {
    if (s.schemaEnv.root.dynamicAnchors[a]) {
      const u = r.let("_v", (0, ja._)`${hh.default.dynamicAnchors}${(0, ja.getProperty)(a)}`);
...
const ph = Tt, $h = T, yh = {
  ...
  schemaType: "boolean",
  code(e) {
    e.schema ? (0, ph.dynamicAnchor)(e, "") : (0, $h.checkStrictMode)(e.it, "$recursiveAnchor: false is ignored");
  }
};
Is.default = yh;
var Ns = {};
...
const gh = jt, vh = {
  ...
  schemaType: "string",
  code: (e) => (0, gh.dynamicRef)(e, e.schema)
};
Ns.default = vh;
Object.defineProperty(Rs, "__esModule", { value: !0 });
const _h = Tt, Eh = jt, wh = Is, bh = Ns, Sh = [_h.default, Eh.default, wh.default, bh.default];
Rs.default = Sh;
var Os = {}, Ts = {};
...
const ka = Lr, Ph = {
  ...
  schemaType: "object",
  error: ka.error,
  code: (e) => (0, ka.validatePropertyDeps)(e)
};
Ts.default = Ph;
var js = {};
...
const Rh = Lr, Ih = {
  ...
  type: "object",
  schemaType: "object",
  code: (e) => (0, Rh.validateSchemaDeps)(e)
};
js.default = Ih;
var As = {};
Object.defineProperty(As, "__esModule", { value: !0 });
const Nh = T, Oh = {
  ...
  schemaType: "number",
  code({ keyword: e, parentSchema: t, it: r }) {
    t.contains === void 0 && (0, Nh.checkStrictMode)(r, `"${e}" without "contains" is ignored`);
  }
};
As.default = Oh;
Object.defineProperty(Os, "__esModule", { value: !0 });
const Th = Ts, jh = js, Ah = As, kh = [Th.default, jh.default, Ah.default];
Os.default = kh;
var ks = {}, Cs = {};
Object.defineProperty(Cs, "__esModule", { value: !0 });
const Be = F, Ca = T, Ch = Ee, Dh = {
  ...
  code(e) {
    ...
    l instanceof Be.Name ? t.if((0, Be._)`${l} !== true`, () => t.forIn("key", n, (f) => t.if(u(l, f), () => i(f)))) : l !== !0 && t.forIn("key", n, (f) => l === void 0 ? i(f) : t.if(c(l, f), () => i(f))), a.props = !0, e.ok((0, Be._)`${s} === ${Ch.default.errors}`);
    function i(f) {
      if (r === !1) {
        e.setParams({ unevaluatedProperty: f }), e.error(), o || t.break();
        return;
      }
      if (!(0, Ca.alwaysValidSchema)(a, r)) {
...
const st = F, Da = T, Mh = {
  ...
  code(e) {
    ...
    function l(i, u) {
      t.forRange("i", u, o, (c) => {
        e.subschema({ keyword: "unevaluatedItems", dataProp: c, dataPropType: Da.Type.Num }, i), s.allErrors || t.if((0, st.not)(i), () => t.break());
      });
    }
  }
};
...
const Uh = Cs, zh = Ds, Fh = [Uh.default, zh.default];
ks.default = Fh;
var Vr = {}, Ls = {};
Object.defineProperty(Ls, "__esModule", { value: !0 });
const re = F, qh = {
...
Object.defineProperty(ts, "__esModule", { value: !0 });
const Xh = kr, Wh = Cr, Bh = Dr, Jh = Rs, xh = Os, Yh = ks, Zh = Vr, La = lt, Qh = [
  Jh.default,
  Xh.default,
  Wh.default,
  (0, Bh.default)(!0),
...
const yt = F, On = zr, Va = pe, em = ut, tm = T, rm = {
  ...
  code(e) {
    ...
    function _() {
      ...
      for (let O = 0; O < o.length; O++) {
        let j = o[O];
        if (j != null && j.$ref && !(0, tm.schemaHasRulesButRef)(j, a.self.RULES)) {
          const te = j.$ref;
          if (j = Va.resolveRef.call(a.self, a.schemaEnv.root, a.baseId, te), j instanceof Va.SchemaEnv && (j = j.schema), j === void 0)
            throw new em.default(a.opts.uriResolver, a.baseId, te);
        }
...
Ur.default = nm;
var Ms = {};
const sm = "https://json-schema.org/draft/2020-12/schema", am = "https://json-schema.org/draft/2020-12/schema", om = {
...
}, im = "meta", cm = "Core and Validation specifications meta-schema", lm = [
  {
    $ref: "meta/core"
  },
  {
  ...
  "object",
  "boolean"
], dm = "This meta-schema also defines keywords that have appeared in previous drafts in order to prevent incompatible extensions as they remain in common use.", fm = {
  definitions: {
  ...
  $comment: dm,
  properties: fm
}, mm = "https://json-schema.org/draft/2020-12/schema", pm = "https://json-schema.org/draft/2020-12/meta/applicator", $m = {
  "https://json-schema.org/draft/2020-12/vocab/applicator": !0
}, ym = "meta", gm = "Applicator vocabulary meta-schema", vm = [
  "object",
  "boolean"
], _m = {
  prefixItems: {
  ...
  properties: _m,
  $defs: Em
}, bm = "https://json-schema.org/draft/2020-12/schema", Sm = "https://json-schema.org/draft/2020-12/meta/unevaluated", Pm = {
  "https://json-schema.org/draft/2020-12/vocab/unevaluated": !0
}, Rm = "meta", Im = "Unevaluated applicator vocabulary meta-schema", Nm = [
  "object",
  "boolean"
], Om = {
  unevaluatedItems: {
  ...
  type: Nm,
  properties: Om
}, jm = "https://json-schema.org/draft/2020-12/schema", Am = "https://json-schema.org/draft/2020-12/meta/content", km = {
  "https://json-schema.org/draft/2020-12/vocab/content": !0
}, Cm = "meta", Dm = "Content vocabulary meta-schema", Lm = [
  "object",
  "boolean"
], Mm = {
  contentEncoding: {
  ...
  type: Lm,
  properties: Mm
}, Um = "https://json-schema.org/draft/2020-12/schema", zm = "https://json-schema.org/draft/2020-12/meta/core", Fm = {
  "https://json-schema.org/draft/2020-12/vocab/core": !0
}, qm = "meta", Gm = "Core vocabulary meta-schema", Km = [
  "object",
  "boolean"
], Hm = {
  $id: {
  ...
  properties: Hm,
  $defs: Xm
}, Bm = "https://json-schema.org/draft/2020-12/schema", Jm = "https://json-schema.org/draft/2020-12/meta/format-annotation", xm = {
  "https://json-schema.org/draft/2020-12/vocab/format-annotation": !0
}, Ym = "meta", Zm = "Format vocabulary meta-schema for annotation results", Qm = [
  "object",
  "boolean"
], ep = {
  format: {
  ...
  type: Qm,
  properties: ep
}, rp = "https://json-schema.org/draft/2020-12/schema", np = "https://json-schema.org/draft/2020-12/meta/meta-data", sp = {
  "https://json-schema.org/draft/2020-12/vocab/meta-data": !0
}, ap = "meta", op = "Meta-data vocabulary meta-schema", ip = [
  "object",
  "boolean"
], cp = {
  title: {
  ...
  type: ip,
  properties: cp
}, up = "https://json-schema.org/draft/2020-12/schema", dp = "https://json-schema.org/draft/2020-12/meta/validation", fp = {
  "https://json-schema.org/draft/2020-12/vocab/validation": !0
}, hp = "meta", mp = "Validation vocabulary meta-schema", pp = [
  "object",
  "boolean"
], $p = {
  type: {
...
Object.defineProperty(Ms, "__esModule", { value: !0 });
const vp = hm, _p = wm, Ep = Tm, wp = Vm, bp = Wm, Sp = tp, Pp = lp, Rp = gp, Ip = ["/properties"];
function Np(e) {
  return [
    vp,
    _p,
  ...
  function t(r, n) {
    return e ? r.$dataMetaSchema(n, Ip) : n;
  }
}
Ms.default = Np;
(function(e, t) {
...
var Op = wn.exports, Tn = { exports: {} }, $i = {};
(function(e) {
...
Object.defineProperty(Vs, "__esModule", { value: !0 });
const Tp = kr, jp = Cr, Ap = Dr, kp = Vr, Ua = lt, Cp = [
  Tp.default,
  jp.default,
  (0, Ap.default)(),
  kp.default,
  Ua.metadataVocabulary,
  Ua.contentVocabulary
];
Vs.default = Cp;
const Dp = "http://json-schema.org/draft-07/schema#", Lp = "http://json-schema.org/draft-07/schema#", Mp = "Core schema meta-schema", Vp = {
  schemaArray: {
    type: "array",
    minItems: 1,
    items: {
...
(function(e, t) {
  ...
  const r = zn, n = Vs, s = Ur, a = Fp, o = ["/properties"], l = "http://json-schema.org/draft-07/schema";
...
(function(e) {
  ...
  const t = qp, r = F, n = r.operators, s = {
...
var Gp = Tn.exports;
const Kp = /* @__PURE__ */ mo(Gp), Hp = (e, t, r, n) => {
  if (r === "length" || r === "prototype" || r === "arguments" || r === "caller")
    return;
  const s = Object.getOwnPropertyDescriptor(e, r), a = Object.getOwnPropertyDescriptor(t, r);
  !Xp(s, a) && n || Object.defineProperty(e, r, a);
}, Xp = function(e, t) {
...
${t}`, Jp = Object.getOwnPropertyDescriptor(Function.prototype, "toString"), xp = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name"), Yp = (e, t, r) => {
  const n = r === "" ? "" : `with ${r.trim()}() `, s = Bp.bind(null, n, t.toString());
...
function Zp(e, t, { ignoreNonConfigurable: r = !1 } = {}) {
  const { name: n } = e;
  for (const s of Reflect.ownKeys(t))
    Hp(e, t, s, r);
  return Wp(e, t), Yp(e, t, n), e;
}
const za = (e, t = {}) => {
  ...
  return Zp(u, e), u.cancel = () => {
    o && (clearTimeout(o), o = void 0), l && (clearTimeout(l), l = void 0);
  }, u;
};
var An = { exports: {} };
const Qp = "2.0.0", gi = 256, e$ = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, t$ = 16, r$ = gi - 6, n$ = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var Fr = {
  ...
  MAX_SAFE_INTEGER: e$,
  RELEASE_TYPES: n$,
  SEMVER_SPEC_VERSION: Qp,
  FLAG_INCLUDE_PRERELEASE: 1,
  FLAG_LOOSE: 2
};
const s$ = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...e) => console.error("SEMVER", ...e) : () => {
};
var qr = s$;
(function(e, t) {
  const {
...
var tr = An.exports;
const a$ = Object.freeze({ loose: !0 }), o$ = Object.freeze({}), i$ = (e) => e ? typeof e != "object" ? a$ : e : o$;
var Us = i$;
const Fa = /^[0-9]+$/, vi = (e, t) => {
  const r = Fa.test(e), n = Fa.test(t);
...
const lr = qr, { MAX_LENGTH: qa, MAX_SAFE_INTEGER: ur } = Fr, { safeRe: dr, t: fr } = tr, l$ = Us, { compareIdentifiers: mt } = _i;
let u$ = class Ae {
  constructor(t, r) {
    if (r = l$(r), t instanceof Ae) {
    ...
    if (t.length > qa)
      throw new TypeError(
        `version is longer than ${qa} characters`
      );
...
var m$ = h$;
const p$ = At, $$ = (e, t) => {
  const r = p$(e.trim().replace(/^[=v]+/, ""), t);
  return r ? r.version : null;
};
var y$ = $$;
const Ka = $e, g$ = (e, t, r, n, s) => {
...
var v$ = g$;
const Ha = At, _$ = (e, t) => {
  const r = Ha(e, null, !0), n = Ha(t, null, !0), s = r.compare(n);
  if (s === 0)
    return null;
...
var E$ = _$;
const w$ = $e, b$ = (e, t) => new w$(e, t).major;
var S$ = b$;
const P$ = $e, R$ = (e, t) => new P$(e, t).minor;
var I$ = R$;
const N$ = $e, O$ = (e, t) => new N$(e, t).patch;
var T$ = O$;
const j$ = At, A$ = (e, t) => {
  const r = j$(e, t);
...
var k$ = A$;
const Xa = $e, C$ = (e, t, r) => new Xa(e, r).compare(new Xa(t, r));
var Te = C$;
const D$ = Te, L$ = (e, t, r) => D$(t, e, r);
var M$ = L$;
const V$ = Te, U$ = (e, t) => V$(e, t, !0);
var z$ = U$;
const Wa = $e, F$ = (e, t, r) => {
  const n = new Wa(e, r), s = new Wa(t, r);
  return n.compare(s) || n.compareBuild(s);
};
var zs = F$;
const q$ = zs, G$ = (e, t) => e.sort((r, n) => q$(r, n, t));
var K$ = G$;
const H$ = zs, X$ = (e, t) => e.sort((r, n) => H$(n, r, t));
var W$ = X$;
const B$ = Te, J$ = (e, t, r) => B$(e, t, r) > 0;
var Gr = J$;
...
var Gs = ay;
const oy = Ei, iy = wi, cy = Gr, ly = qs, uy = Fs, dy = Gs, fy = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var bi = fy;
const hy = $e, my = At, { safeRe: hr, t: mr } = tr, py = (e, t) => {
  if (e instanceof hy)
    return e;
...
function je() {
  ...
  pn = t;
  const r = gy, n = new r(), s = Us, a = Kr(), o = qr, l = $e, {
    safeRe: i,
    t: u,
...
var Hr = _y;
const Ey = je(), wy = (e, t) => new Ey(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var by = wy;
const Sy = $e, Py = je(), Ry = (e, t, r) => {
  ...
  return e.forEach((o) => {
    a.test(o) && (!n || s.compare(o) === -1) && (n = o, s = new Sy(n, r));
  }), n;
};
var Iy = Ry;
const Ny = $e, Oy = je(), Ty = (e, t, r) => {
  let n = null, s = null, a = null;
  try {
    a = new Oy(t, r);
  } catch {
  ...
  return e.forEach((o) => {
    a.test(o) && (!n || s.compare(o) === 1) && (n = o, s = new Ny(n, r));
  }), n;
};
var jy = Ty;
const yn = $e, Ay = je(), xa = Gr, ky = (e, t) => {
  e = new Ay(e, t);
  let r = new yn("0.0.0");
...
var My = Ly;
const Vy = $e, Si = Kr(), { ANY: Uy } = Si, zy = je(), Fy = Hr, Ya = Gr, Za = Fs, qy = Gs, Gy = qs, Ky = (e, t, r, n) => {
  e = new Vy(e, n), t = new zy(t, n);
  let s, a, o, l, i;
  switch (r) {
    case ">":
      s = Ya, a = qy, o = Za, l = ">", i = ">=";
  ...
  for (let u = 0; u < t.set.length; ++u) {
    ...
    let f = null, _ = null;
    if (c.forEach(($) => {
      $.semver === Uy && ($ = new Si(">=0.0.0")), f = f || $, _ = _ || $, s($.semver, f.semver, n) ? f = $ : o($.semver, _.semver, n) && (_ = $);
...
var Ks = Ky;
const Hy = Ks, Xy = (e, t, r) => Hy(e, t, ">", r);
var Wy = Xy;
const By = Ks, Jy = (e, t, r) => By(e, t, "<", r);
var xy = Jy;
const Qa = je(), Yy = (e, t, r) => (e = new Qa(e, r), t = new Qa(t, r), e.intersects(t, r));
var Zy = Yy;
const Qy = Hr, e0 = Te;
var t0 = (e, t, r) => {
  const n = [];
  let s = null, a = null;
  const o = e.sort((c, f) => e0(c, f, r));
  for (const c of o)
    Qy(c, t, r) ? (a = c, s || (s = c)) : (a && n.push([s, a]), a = null, s = null);
  s && n.push([s, null]);
  const l = [];
  for (const [c, f] of n)
...
const eo = je(), Hs = Kr(), { ANY: gn } = Hs, zt = Hr, Xs = Te, r0 = (e, t, r = {}) => {
  if (e === t)
    return !0;
  e = new eo(e, r), t = new eo(t, r);
  let n = !1;
  ...
  return !0;
}, n0 = [new Hs(">=0.0.0-0")], to = [new Hs(">=0.0.0")], s0 = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === gn) {
    if (t.length === 1 && t[0].semver === gn)
      return !0;
    r.includePrerelease ? e = n0 : e = to;
  }
  if (t.length === 1 && t[0].semver === gn) {
  ...
  let s, a;
  for (const $ of e)
    $.operator === ">" || $.operator === ">=" ? s = ro(s, $, r) : $.operator === "<" || $.operator === "<=" ? a = no(a, $, r) : n.add($.semver);
  if (n.size > 1)
    return null;
  let o;
  if (s && a) {
  ...
  for (const $ of n) {
    if (s && !zt($, String(s), r) || a && !zt($, String(a), r))
      return null;
    for (const E of t)
      if (!zt($, String(E), r))
        return !1;
  ...
  for (const $ of t) {
    if (c = c || $.operator === ">" || $.operator === ">=", u = u || $.operator === "<" || $.operator === "<=", s) {
      if (_ && $.semver.prerelease && $.semver.prerelease.length && $.semver.major === _.major && $.semver.minor === _.minor && $.semver.patch === _.patch && (_ = !1), $.operator === ">" || $.operator === ">=") {
        if (l = ro(s, $, r), l === $ && l !== s)
          return !1;
      } else if (s.operator === ">=" && !zt(s.semver, String($), r))
        return !1;
    }
    if (a) {
      if (f && $.semver.prerelease && $.semver.prerelease.length && $.semver.major === f.major && $.semver.minor === f.minor && $.semver.patch === f.patch && (f = !1), $.operator === "<" || $.operator === "<=") {
        if (i = no(a, $, r), i === $ && i !== a)
          return !1;
      } else if (a.operator === "<=" && !zt(a.semver, String($), r))
        return !1;
    }
    if (!$.operator && (a || s) && o !== 0)
      return !1;
...
var a0 = r0;
const vn = tr, so = Fr, o0 = $e, ao = _i, i0 = At, c0 = m$, l0 = y$, u0 = v$, d0 = E$, f0 = S$, h0 = I$, m0 = T$, p0 = k$, $0 = Te, y0 = M$, g0 = z$, v0 = zs, _0 = K$, E0 = W$, w0 = Gr, b0 = Fs, S0 = Ei, P0 = wi, R0 = qs, I0 = Gs, N0 = bi, O0 = $y, T0 = Kr(), j0 = je(), A0 = Hr, k0 = by, C0 = Iy, D0 = jy, L0 = Cy, M0 = My, V0 = Ks, U0 = Wy, z0 = xy, F0 = Zy, q0 = t0, G0 = a0;
var K0 = {
  parse: i0,
  valid: c0,
  clean: l0,
  ...
  src: vn.src,
  tokens: vn.t,
  SEMVER_SPEC_VERSION: so.SEMVER_SPEC_VERSION,
  RELEASE_TYPES: so.RELEASE_TYPES,
  compareIdentifiers: ao.compareIdentifiers,
  rcompareIdentifiers: ao.rcompareIdentifiers
};
const pt = /* @__PURE__ */ mo(K0), H0 = Object.prototype.toString, X0 = "[object Uint8Array]", W0 = "[object ArrayBuffer]";
function Pi(e, t, r) {
  return e ? e.constructor === t ? !0 : H0.call(e) === r : !1;
}
function Ri(e) {
  return Pi(e, Uint8Array, X0);
}
function B0(e) {
...
function oo(e, t) {
  ...
  let n = 0;
  for (const s of e)
    x0(s), r.set(s, n), n += s.length;
  return r;
}
const pr = {
  utf8: new globalThis.TextDecoder("utf8")
};
function io(e, t = "utf8") {
  return Y0(e), pr[t] ?? (pr[t] = new globalThis.TextDecoder(t)), pr[t].decode(e);
}
function Z0(e) {
  if (typeof e != "string")
    throw new TypeError(`Expected \`string\`, got \`${typeof e}\``);
}
const Q0 = new globalThis.TextEncoder();
function _n(e) {
  return Z0(e), Q0.encode(e);
}
Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
const eg = Kp.default, co = "aes-256-cbc", $t = () => /* @__PURE__ */ Object.create(null), tg = (e) => e != null, rg = (e, t) => {
...
class ng {
  constructor(t = {}) {
    ...
    if (!r.cwd) {
      ...
      r.cwd = Ec(r.projectName, { suffix: r.projectSuffix }).config;
    }
    if (Lt(this, _e, r), r.schema ?? r.ajvOptions ?? r.rootSchema) {
      if (r.schema && typeof r.schema != "object")
        throw new TypeError("The `schema` option must be an object.");
      const o = new Op.Ajv2020({
        allErrors: !0,
        useDefaults: !0,
        ...r.ajvOptions
      });
      ...
      Lt(this, Ye, o.compile(l));
      for (const [i, u] of Object.entries(r.schema ?? {}))
        u != null && u.default && (Q(this, Ve)[i] = u.default);
    }
    r.defaults && Lt(this, Ve, {
      ...Q(this, Ve),
      ...r.defaults
    }), r.serialize && (this._serialize = r.serialize), r.deserialize && (this._deserialize = r.deserialize), this.events = new EventTarget(), Lt(this, Me, r.encryptionKey);
  ...
  set(t, r) {
    ...
    const { store: n } = this, s = (a, o) => {
      rg(a, o), Q(this, _e).accessPropertiesByDotNotation ? na(n, a, o) : n[a] = o;
    };
    if (typeof t == "object") {
      const a = t;
  ...
  /**
      ...
      */
  has(t) {
    return Q(this, _e).accessPropertiesByDotNotation ? yc(this.store, t) : t in this.store;
  }
  /**
  ...
  reset(...t) {
    for (const r of t)
      tg(Q(this, Ve)[r]) && this.set(r, Q(this, Ve)[r]);
  }
  delete(t) {
    const { store: r } = this;
    Q(this, _e).accessPropertiesByDotNotation ? $c(r, t) : delete r[t], this.store = r;
  }
  /**
      Delete all items.
  ...
  *[Symbol.iterator]() {
  ...
  _encryptData(t) {
    if (!Q(this, Me))
      return typeof t == "string" ? t : io(t);
    try {
      const r = t.slice(0, 16), n = Mt.pbkdf2Sync(Q(this, Me), r.toString(), 1e4, 32, "sha512"), s = Mt.createDecipheriv(co, n, r), a = t.slice(17), o = typeof a == "string" ? _n(a) : a;
      return io(oo([s.update(o), s.final()]));
    } catch {
    }
    return t.toString();
  }
  ...
  _write(t) {
    ...
    if (Q(this, Me)) {
      const n = Mt.randomBytes(16), s = Mt.pbkdf2Sync(Q(this, Me), n.toString(), 1e4, 32, "sha512"), a = Mt.createCipheriv(co, s, n);
      r = oo([n, _n(":"), a.update(_n(r)), a.final()]);
    }
    if (se.env.SNAP)
  ...
  _watch() {
    this._ensureDirectory(), G.existsSync(this.path) || this._write($t()), se.platform === "win32" ? G.watch(this.path, { persistent: !1 }, za(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 100 })) : G.watchFile(this.path, { persistent: !1 }, za(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 5e3 }));
  }
  _migrate(t, r, n) {
  ...
  _get(t, r) {
    return pc(this.store, t, r);
  }
  _set(t, r) {
    const { store: n } = this;
    na(n, t, r), this.store = n;
  }
}
Ye = new WeakMap(), Me = new WeakMap(), _e = new WeakMap(), Ve = new WeakMap();
const { app: wr, ipcMain: kn, shell: sg } = Ln;
let lo = !1;
const uo = () => {
  if (!kn || !wr)
  ...
  return lo || (kn.on("electron-store-get-data", (t) => {
    t.returnValue = e;
  }), lo = !0), e;
};
class ag extends ng {
  constructor(t) {
    let r, n;
    if (se.type === "renderer") {
      const s = Ln.ipcRenderer.sendSync("electron-store-get-data");
      if (!s)
        throw new Error("Electron Store: You need to call `.initRenderer()` from the main process.");
      ({ defaultCwd: r, appVersion: n } = s);
    } else kn && wr && ({ defaultCwd: r, appVersion: n } = uo());
    t = {
      name: "config",
      ...t
  ...
  async openInEditor() {
    const t = await sg.openPath(this.path);
    if (t)
      throw new Error(t);
  }
}
const Cn = new ag({
  ...
  Et.handle("get-setting", (e, t) => Cn.get(t)), Et.handle(
    "set-setting",
    (e, t, r) => {
      Cn.set(t, r), e.sender.send("setting-changed", t, r);
    }
  );
}, Gt = (e, t, r) => {
  Cn.set(t, r), e.webContents.send("setting-changed", t, r);
}, Ws = "tabzero", Ii = async (e, t) => {
  const r = new URL(t);
  if (!r.protocol.startsWith(Ws)) return "not a valid url";
  const n = new URLSearchParams(r.search), s = n.get("code"), a = n.get("scope"), o = n.get("referral");
  if (!s || !a) return "no scope or code";
  o && Gt(e, "referral", o), e.webContents.send("auth", { code: s, scope: a });
}, ig = (e) => {
  Oe.setAsDefaultProtocolClient(Ws), Oe.on("open-url", async (t, r) => {
    Ii(e, r);
  });
}, cg = (e) => {
  try {
  ...
  const t = new Ui({ port: ug, perMessageDeflate: !1 });
  Gt(e, "streamDeck", !1), Et.handle(
    "send-to-stream-deck",
    (r, n) => {
      t.clients.forEach((s) => {
    ...
    console.error("[WS] Error:", r), Gt(e, "streamDeck", !1);
  }), t.on("connection", (r) => {
    console.log("[WS] Plugin connected"), Gt(e, "streamDeck", !0), r.on("message", (n) => {
      switch (n.toString()) {
      ...
      console.log("[WS] Plugin disconnected"), Gt(e, "streamDeck", !1);
    });
  });
}, fg = Mi(import.meta.url), Ni = X.dirname(Vi(import.meta.url));
Oe.setAppUserModelId("com.haydncom.tabzero");
fg("electron-squirrel-startup") && Oe.quit();
process.env.APP_ROOT = X.join(Ni, "..");
const Dn = process.env.VITE_DEV_SERVER_URL, Pg = X.join(process.env.APP_ROOT, "dist-electron"), Oi = X.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = Dn ? X.join(process.env.APP_ROOT, "public") : Oi;
let ie;
nc();
function Ti() {
  ie = new fo({
  ...
  }), Dn ? ie.loadURL(Dn) : ie.loadFile(X.join(Oi, "index.html")), ig(ie), lg(ie), dg(ie);
}
Oe.on("window-all-closed", () => {
  process.platform !== "darwin" && (Oe.quit(), ie = null);
});
Oe.on("activate", () => {
  fo.getAllWindows().length === 0 && Ti();
});
og();
hc();
if (!Oe.requestSingleInstanceLock())
  ...
  const e = async (t) => {
    if (!ie) return;
    const r = t.find((n) => n.startsWith(`${Ws}://`));
    r && Ii(ie, r);
  };
